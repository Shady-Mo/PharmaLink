...
public class DrugDto
{
    ...
    public DrugCategoryDto? Category { get; set; }

    public ICollection<DrugSupplierDto> Suppliers { get; set; } = new List<DrugSupplierDto>();
    public ICollection<DrugLandingPageDto> LandingPages { get; set; } = new List<DrugLandingPageDto>();
}