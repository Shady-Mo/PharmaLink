...
namespace Infrastructure.Migrations
{
    ...
    [Migration("20260717070200_RestrictPharmacyAdminToAtMostOnePharmacy")]
    partial class RestrictPharmacyAdminToAtMostOnePharmacy
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Domain.Entities.PharmacyAdminPharmacy", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.HasIndex("PharmacyAdminId")
                        .IsUnique()
                        .HasDatabaseName("IX_PharmacyAdminPharmacies_OnlyOneActivePharmacyPerAdmin")
                        .HasFilter("[IsActive] = 1");

                    b.HasIndex("PharmacyId")
                        .HasDatabaseName("IX_PharmacyAdminPharmacies_PharmacyId");

                    b.HasIndex("PharmacyAdminId", "PharmacyId")
                        .IsUnique()
                        .HasDatabaseName("IX_PharmacyAdminPharmacies_UniqueAssignment");

                    b.ToTable("PharmacyAdminPharmacies");
                });
            ...
            modelBuilder.Entity("Domain.Entities.PharmacistAssignment", b =>
                {
                    b.HasOne("Domain.Entities.SystemAdmin", "AssignedByAdmin")
                        .WithMany()
            ...
            modelBuilder.Entity("Domain.Entities.PharmacyAdminPharmacy", b =>
                {
                    b.HasOne("Domain.Entities.PharmacyAdmin", "PharmacyAdmin")
