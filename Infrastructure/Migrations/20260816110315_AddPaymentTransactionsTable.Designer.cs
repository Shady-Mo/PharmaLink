...
namespace Infrastructure.Migrations
{
    ...
    [Migration("20260816110315_AddPaymentTransactionsTable")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Domain.Entities.RAG.PrescriptionVectorIndex", b =>
                {
                    b.Property<Guid>("PrescriptionVectorIndexId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.HasKey("PrescriptionVectorIndexId");
                    ...
                    b.ToTable("PrescriptionVectorIndices", (string)null);
                });

            modelBuilder.Entity("Domain.Entities.RecurringPrescription", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Domain.Entities.RecurringPrescriptionRun", b =>
                {
                    ...
                    b.Property<Guid>("RecurringPrescriptionId")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Domain.Entities.PrescriptionReviewTeam", b =>
                {
                    b.HasBaseType("Domain.Entities.AppUser");

                    b.HasDiscriminator().HasValue("PrescriptionReviewTeam");
                });
            ...
            modelBuilder.Entity("Domain.Entities.MedicineReminderLog", b =>
                {
                    b.HasOne("Domain.Entities.MedicineReminder", "Reminder")
                        .WithMany("Logs")
            ...
            modelBuilder.Entity("Domain.Entities.RAG.PrescriptionVectorIndex", b =>
                {
                    b.HasOne("Domain.Entities.PharmacyBranch", "PharmacyBranch")
                        .WithMany()
                        .HasForeignKey("BranchId")
                        .OnDelete(DeleteBehavior.SetNull);
            ...
            modelBuilder.Entity("Domain.Entities.RecurringPrescription", b =>
                {
                    ...
                    b.HasOne("Domain.Entities.PharmacyBranch", "PreferredBranch")
                        .WithMany()
            ...
            modelBuilder.Entity("Domain.Entities.RecurringPrescriptionRun", b =>
                {
                    b.HasOne("Domain.Entities.RecurringPrescription", "RecurringPrescription")
                        .WithMany("Runs")
                        .HasForeignKey("RecurringPrescriptionId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("RecurringPrescription");
                });
